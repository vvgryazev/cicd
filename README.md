# Домашнее задание к занятию "Кластеризация и балансировка нагрузки" - `Gryazev Vadim`
...
1. ![jenkins](/img/50.PNG)
2. ![jenkins](/img/51.PNG)
...
1. ![jenkins](/img/52.PNG)


2. ![jenkins](/img/53.PNG)
